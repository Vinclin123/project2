...
if(isset($_REQUEST['save']))
{
  ...
  //end of of varibale and value setting
	...
	$query = "INSERT INTO `basic_details`(`user_code`, `name`, `address`, `email`, `mobile`, `profile`, `objective`, `declaration`, `id`) VALUES ('$id','$user_code','$name','$address','$email','$mobile','$profile','$objective','$declaration')";  
...
if(isset($_REQUEST['edit'])){
  ...
  //end of of varibale and value setting
  //start of typing  query
	$query = "UPDATE `basic_details` SET `user_code`='$user_code',`name`='$name',`address`='$address',`email`='$email',`mobile`='$mobile',`profile`='$profile',`objective`='$objective',`declaration`='$declaration',`id`='$id'";  
  // end of typing  query
	$message=iud_data($query);
  if($message=="sucess"){
		echo"<script>alert('data saved successfully ')</script>";
