...
if(isset($_REQUEST['save']))
{
  ...
  //end of of varibale and value setting
	...
	$query = "INSERT INTO `education_details`(`id`, `user_code`, `coursename`, `university`, `college`, `passyear`, `percentage`) VALUES ('$id','$user_code','$coursename','$university','$college','$passyear','$percentage')";  
...
if(isset($_REQUEST['edit'])){
  ...
  //end of of varibale and value setting
  //start of typing  query
	$query = "UPDATE `education_details` SET `id`='$id',`user_code`='$user_code',`coursename`='$coursename',`university`='$university',`college`='$college',`passyear`='$passyear',`percentage`='$percentage'";  
  // end of typing  query
	$message=iud_data($query);
  if($message=="sucess"){
		echo"<script>alert('data saved successfully ')</script>";
...
<div class="container">
  ...
  <td>
    <input type="text" name="passyear" class="form-control" value="<?php if($action=="edit"){ echo $data['passyear'];} else { echo "";} ?>"  required="required">
   </td>
  </tr>
  <tr>
  <td align="right"><b>percentage<b></td>
  <td>
    <input type="text" name="percentage" class="form-control" value="<?php if($action=="edit"){ echo $data['percentage'];} else { echo "";} ?>"  required="required">
   </td>
  </tr>
  <tr>
